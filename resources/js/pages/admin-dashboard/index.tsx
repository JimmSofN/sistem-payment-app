...
export default function AdminDashboard({ payments = [], total = 0, per_page = 10, current_page = 1, flash }: Props) {
    ...
    const handlePageChange = (page: number) => {
        setCurrentPage(page);
        window.location.href = `/dashboard?page=${page}${searchTerm ? `&search=${encodeURIComponent(searchTerm)}` : ''}`;
    };
