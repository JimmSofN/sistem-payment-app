...
class VerifikasiPembayaranController extends Controller
{
    public function index(Request $request)
    {
        ...
        return Inertia::render('verifikasi-pengajuan/index', [
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('verifikasi-pengajuan/edit', [
            'payment' => [
                'id' => $payment->id,
                'nis' => $payment->nis,
    ...
    public function update(Request $request, $id)
    {
        ...
        return Redirect::route('verifikasi-pengajuan.index')->with('success', 'Status pembayaran berhasil diperbarui.');
    }
}